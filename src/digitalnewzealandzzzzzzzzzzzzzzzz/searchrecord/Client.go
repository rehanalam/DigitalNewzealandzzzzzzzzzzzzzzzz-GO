...
import(
    ...
    "digitalnewzealandzzzzzzzzzzzzzzzz"
    "digitalnewzealandzzzzzzzzzzzzzzzz/apihelper"
    "digitalnewzealandzzzzzzzzzzzzzzzz/models"
)
...
func (me *SEARCHRECORD_IMPL) SearchRecord (input *SearchRecordInput) (*models.CollectionSearchRecords, error) {
    ...
    queryBuilder := digitalnewzealandzzzzzzzzzzzzzzzz.BASEURI;
    ...
    queryBuilder, err = apihelper.AppendUrlWithQueryParameters(queryBuilder, map[string]interface{} {
        ...
        "api_key" : digitalnewzealandzzzzzzzzzzzzzzzz.Config.ApiKey,
    })
    if err != nil {
